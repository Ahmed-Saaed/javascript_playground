// for a certain project you need a different data structure, here we used objects instead of arrays
// to save the bookmarks as it will be less expensive for search and delete.
